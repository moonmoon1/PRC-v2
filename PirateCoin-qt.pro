...
QMAKE_CXXFLAGS += -msse2 -lwininet
QMAKE_CFLAGS += -msse2 -lwininet
QMAKE_CXXFLAGS_WARN_ON = -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector -lwininet
...
macx:ICON = src/qt/res/icons/PirateCoin.icns
...
LIBS += -lssl -lcrypto -ldb_cxx$$BDB_LIB_SUFFIX -lwininet
# -lgdi32 has to happen after -lcrypto (see  #681)
windows:LIBS += -lws2_32 -lshlwapi -lmswsock -lole32 -loleaut32 -luuid -lgdi32 -lwininet
LIBS += -lboost_system$$BOOST_LIB_SUFFIX -lboost_filesystem$$BOOST_LIB_SUFFIX -lboost_program_options$$BOOST_LIB_SUFFIX -lboost_thread$$BOOST_THREAD_LIB_SUFFIX -lwininet
windows:LIBS += -lboost_chrono$$BOOST_LIB_SUFFIX -lwininet

contains(RELEASE, 1) {
    !windows:!macx {
        # Linux: turn dynamic linking back on for c/c++ runtime libraries
        LIBS += -Wl,-Bdynamic, -lwininet
    }
}
