...
int64 nChainStartTime = 1406553268;
...
static const int64 nTargetTimespan = 999999 * 60;  
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Update nTime every few seconds,need to update coinbase timestamp.";
        CTransaction txNew;
		...
		block.print();
        assert(block.hashMerkleRoot == uint256("0x84687bdecef2229341231e76ef70c3815a1b8454164cbdea276fef8158a7293e"));
